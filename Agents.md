...
## UI / Site rules
- Build modern, calm, product-grade interfaces.
- Optimize for comprehension: low cognitive load, clear hierarchy, obvious actions.
- Prefer recognition over recall: visible labels, states, and helper text.
- Prevent slips: separate destructive actions, support undo/recovery, use clear feedback.
- Keep layouts simple, spacing consistent, and body text readable.
- Design mobile-first with accessible contrast, focus states, and tappable targets.
